 ...
 * 
 * This file contains implementations of X.509 certificate operations
 * with function names standardized according to OpenSSL 1.0.1 conventions.
 * Each renamed function includes a comment showing its original function name.
 * 
 * Key functions:
 * - PEM_read_bio_X509() - Read X.509 certificate from BIO
 * - X509_add_cert_to_stack() - Add certificate to stack
 * - PEM_read_bio_X509_CERT() - Read certificate with auxiliary data
 * - X509_get_embedded_cert() - Get embedded certificate
 * - X509_certificate_compare() - Compare X.509 certificates
 * - X509_verify_signature() - Verify certificate signature
 * - X509_parse_signed_file() - Parse signed file containing certificates
 * - X509_extract_fingerprint_block() - Extract fingerprint block
 * - X509_split_certificate_chain() - Split certificate chain
 * - EVP_get_digestbytype() - Select appropriate message digest
 */
...
/* Original function name: FUN_1000bc00 */
unsigned char OPENSSL_str2bool(char *param_1) {
  size_t sVar1;
  char *uVar2;
  int iVar3;
  char *local_24;
  ...
  if (param_1 == (char *)0x0) {
    ...
    OPENSSL_malloc_wrapper((size_t)(sVar1 + 1),local_24,"stobool");
    strcpy(local_24,param_1);
    uVar2 = OPENSSL_strlwr(local_24);
    trimSpaces(uVar2);
    ...
    if ((((iVar3 == 0) || (iVar3 = strcmp(local_24,"yes"), iVar3 == 0)) ||
      ...
      OPENSSL_free_wrapper(local_24,"stobool");
      local_20 = 1;
    }
    else {
...
/* Original function name: FUN_1000be80 */
...
/* Original function name: FUN_1000c09c */
...
/* Original function name: FUN_1000bf58 */
void BIO_base64_encode(void *param_1,uint param_2,unsigned char *param_3,int param_4){
  void *local_38;
  uint local_34;
  ...
  for (; 2 < local_34; local_34 = local_34 - 3) {
    BIO_base64_encode_block(local_38,local_30);
  ...
  if (local_34 != 0) {
    ...
    BIO_base64_encode_block(auStack_28,local_30);
    local_30[3] = 0x3d;
    if (local_34 == 1) {
      local_30[2] = 0x3d;
    }
...
/* Original function name: FUN_1000c18c */
int BIO_base64_decode(char *param_1,void *param_2,uint param_3){
  size_t sVar1;
  int iVar2;
  void *local_44;
  uint local_40;
  ...
  local_18 = 0;
  sVar1 = strlen(param_1);
  OPENSSL_malloc_wrapper(sVar1 + 5,local_3c,"base64_decode");
  if (local_3c == (char *)0x0) {
    ...
    while (local_1c == 3) {
      for (local_20 = 0; local_20 < 4; local_20 = local_20 + 1) {
        while ((*local_38 != '=' && (iVar2 = BIO_base64_char_value(local_38), iVar2 < 0))) {
          local_38 = local_38 + 1;
        }
        acStack_34[local_20] = *local_38;
        local_38 = local_38 + 1;
      }
      local_1c = BIO_base64_decode_block((int*)acStack_34,(int*)auStack_30);
...
/* Original function name: FUN_1000c384 */
...
/* Original function name: FUN_1000c488 */
int BIO_base64_decode_block(int *param_1,int *param_2){
  bool bVar1;
  int iVar2;
  int local_40;
  uint local_3c;
  ...
  for (local_40 = 0; local_40 < 4; local_40 = local_40 + 1) {
    iVar2 = BIO_base64_char_value((char *)(param_1 + local_40));
...
/* Original function name: FUN_1000c6f4 */
unsigned int OPENSSL_malloc_wrapper(size_t param_1,char *param_2,char* param_3) {
  void *pvVar1;
...
void FUN_1000de80(void){
  ...
  if (DAT_10022cc0 != 0) {
    OPENSSL_free_wrapper(DAT_10022cc0,"close_config");
  }
  FUN_1000e38c();
  return;
}
...
/* Original function name: FUN_1000cd38 */
int *X509_get_embedded_signing_cert_data(void){
  ...
  if (DAT_10022c98 == 0) {
    DAT_10022ab4 = 0x794;
    OPENSSL_malloc_wrapper(0x794,(char*)DAT_10022c98,"get_embeded_signing_cert");
  }
...
/* Original function name: FUN_1000ce94 */
long PEM_find_section_length(FILE *param_1,char *param_2)
...
/* Original function name: FUN_1000b9f4 */
unsigned int PEM_read_bio_X509_CERT(char *param_1){
  BIO *bp;
  int iVar1;
  unsigned int local_20;
...
/* Original function name: FUN_1000b770 */
unsigned int X509_add_cert_to_stack(char *param_1){
  BIO *bp;
  X509 *data;
  int iVar1;
  unsigned int local_20;
...
/* Original function name: FUN_1000cff0 */
int X509_split_certificate_chain(FILE *param_1){
  int iVar1;
  int iVar2;
  char *pcVar3;
  int local_434;
  ...
  if (param_1 == (FILE *)0x0) {
    ...
    local_428 = 0x800;
  iVar1 = OPENSSL_malloc_wrapper(0x800,local_424,"split_cert_chain");
    if (iVar1 == -1) {
      local_20 = -1;
    }
    else {
      do {
        while( true ) {
          ...
          if (iVar1 == 0) break;
          PEM_buffer_append(&local_428,acStack_420);
          memset(acStack_420,0,0x400);
        }
        strcat(local_424,"-----END CERTIFICATE-----\n");
        if (DAT_10022c9c == 0) {
          DAT_10022c9c = 1;
          local_434 = PEM_read_bio_X509_CERT(local_424);
        }
        else {
          local_434 = X509_add_cert_to_stack(local_424);
        }
        memset(local_424,0,local_428);
      } while (local_434 != -1);
LAB_1000d1ec:
      OPENSSL_free_wrapper(local_424,"split_cert_chain()");
      local_20 = local_434;
    }
  }
  return local_20;
...
/* Original function name: FUN_1000d22c */
void PEM_buffer_append(size_t *param_1,char *param_2){
  size_t sVar1;
  size_t sVar2;
  size_t sVar3;
  void *pvVar4;
...
void FUN_1000e064(char *param_1){
  ...
  if (param_1 == (char *)0x0) {
    ...
    if (DAT_10022cbc != NULL) {
      OPENSSL_free_wrapper(DAT_10022cbc,"set_private_keyID");
    }
    sVar1 = strlen(param_1);
    iVar2 = OPENSSL_malloc_wrapper(sVar1 + 1,DAT_10022cbc,"set_private_keyID");
    if (iVar2 != -1) {
...
void FUN_1000e2b4(int param_1) {
  if (0 < param_1) {
    ...
    OPENSSL_malloc_wrapper(param_1,DAT_10022cc4,"init_signed_hash");
  }
  return;
}
...
/* Original function name: FUN_1000d4dc */
void X509_parse_fingerprint(void){
  unsigned int *iVar1;
  char *pcVar2;
  char *uVar3;
  int uVar4;
  ...
  local_20 = local_20 + 1;
  if ((1 < local_20) &&
     (*iVar1 = OPENSSL_malloc_wrapper(local_20,local_28,"parse_fingerprint()"), *iVar1 != -1)) {
    ...
    while ((
      ...
      if (((local_24 != (char *)0x0) && (*iVar1 = strcmp(local_24,"Signature"), iVar1 == 0)) &&
        ...
        BIO_base64_decode(local_24,uVar3,uVar4);
        uVar4 = DAT_10022cc8;
        BIO_base64_decode(local_24,uVar3,uVar4);
      }
    }
    OPENSSL_free_wrapper(local_28,"parse_fingerprint()");
  }
  return;
}
...
unsigned int FUN_1000dae4(unsigned int param_1){
  ...
  iVar1 = OPENSSL_malloc_wrapper(0x1000,local_24,"validate_stream");
  //iVar1 = FUN_1000c6f4(0,local_24,"validate_stream");
  if (iVar1 == -1) {
    local_18 = 0xffffffff;
  }
  else {
	...
	OPENSSL_free_wrapper(local_24,"validate_stream");	
        return 0xffffffff;
      }
...
/* Original function name: FUN_1000b538 */
...
/* Original function name: FUN_1000d368 */
unsigned int X509_extract_fingerprint_block(FILE *param_1,void *param_2){
  ...
  if (param_1 == NULL) {
    ...
    local_18 = iVar2 + 1;
    if (local_18 != 0) {
      iVar2 = OPENSSL_malloc_wrapper(local_18,local_1c,"split_signed_file():fingerprint");
      if (iVar2 == -1) {
        return 0xffffffff;
      }
      fread(local_1c,local_18,1,param_1);
      *(unsigned char *)((int*)local_1c + local_18 - 1) = 0;
      X509_set_fingerprint_data(local_1c);
      OPENSSL_free_wrapper(local_1c,"split_signed_file():fingerprint");
    }
    iVar2 = X509_split_certificate_chain(param_1);
    if (iVar2 == -1) {
      local_14 = 0xffffffff;
    }
    else {
      X509_parse_fingerprint();
      local_14 = 0;
    }
  }
  return local_14;
...
/* Original function name: FUN_1000b6b0 */
void X509_set_block_length(int param_1){
  if (-1 < param_1) {
...
/* Original function name: FUN_1000dc8c */
...
/* Original function name: FUN_1000bac8 */
...
/* Original function name: FUN_1000d6e0 */
unsigned int X509_parse_signed_file(void){
  ...
  if (__stream == (FILE *)0x0) {
    ...
    *piVar3 = 0;
    ...
    if (bVar1) {
      X509_set_file_offset(local_24);
      local_24 = 0;
      uVar6 = PEM_find_section_length(__stream,"Fingerprint Length:");
      if (uVar6 == 0) {
        printf("Could not find fingerprint in signed file!");
        local_20 = 0xffffffff;
      }
      else {
        X509_set_block_length(uVar6);
        iVar4 = X509_extract_fingerprint_block(__stream,local_28);
        if (iVar4 == -1) {
          printf("Could not extract Certificate chain from signed file!\n");
          local_20 = 0xffffffff;
        }
        else {
          local_20 = 0;
...
void truncateSpaces(char *param_1){
  ...
  if (param_1 != (char *)0x0) {
    ...
    if (0 < (int)sVar1) {
      iVar2 = (int)sVar1 - 1;
      while ((0 < iVar2 && ((param_1[iVar2] == ' ' || (param_1[iVar2] == '\t'))))) {
        param_1[iVar2] = '\0';
        iVar2 = iVar2 + -1;
      }
    }
...
void trimSpaces(char *param_1){
  ...
  if (param_1 != (char *)0x0) {
    ...
    if (0 < (int)sVar2) {
      iVar3 = 0;
      do {
        if ((param_1[iVar3] != ' ') && (param_1[iVar3] != '\t')) break;
        iVar4 = iVar3 + 1;
        iVar3 = iVar4;
