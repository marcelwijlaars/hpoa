...
jsolait=mod;
mod.baseURL="";
mod.libURL="/120814-042457/js";
mod.modules=new Array();
mod.moduleURLs={urllib:"%(libURL)s/urllib.js",
xml:"%(libURL)s/xml.js",
topology:"%(libURL)s/topology.js",
EventManager:"%(libURL)s/eventManager.js",
Soap:"%(libURL)s/globalSoap.js",
CallAnalyzer:"%(libURL)s/callAnalyzer.js",
Transport:"%(libURL)s/transport.js",
StringManager:"%(libURL)s/stringManager.js"};
mod.init=function(){
var ws=null;
try{
}catch(e){
