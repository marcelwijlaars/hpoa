		...
		<xsl:variable name="tableId">
			<xsl:choose>
				<xsl:when test="$deviceType='server'">
					<xsl:value-of select="'ebipaDeviceSummary'" />
				</xsl:when>
				<xsl:when test="$deviceType='interconnect'">
					<xsl:value-of select="'ebipaInterconnectSummary'" />
				</xsl:when>
			</xsl:choose>
		</xsl:variable>
				...
				<tr class="captionRow">
					...
					<th style="vertical-align:middle;" nowrap="true">
						...
						<xsl:element name="input">
							...
							<xsl:attribute name="ebipaDevType"><xsl:value-of select="$deviceType"/></xsl:attribute>
							<xsl:attribute name="onclick">checkboxToggle(this, 'ebipaDevType', '<xsl:value-of select="$deviceType"/>', '<xsl:value-of select="$tableId"/>', true);</xsl:attribute>
					...
					<xsl:if test="$deviceType='interconnect'">
						<th style="vertical-align:middle;" nowrap="true">
							<xsl:value-of select="$stringsDoc//value[@key='ntpServer']" />
						</th>
					</xsl:if>
					<th style="vertical-align:middle;" nowrap="true">
						...
						<xsl:element name="tr">
							...
							<td style="width:10px;">
								...
								<xsl:element name="input">
									...
									<xsl:attribute name="ebipaDevType">
										<xsl:value-of select="$deviceType"/>
									</xsl:attribute>

									<xsl:attribute name="id">
										<xsl:value-of select="concat('enc', $encNum, $deviceType, $bayNumber, 'EbipaBayEnabled')" />
									</xsl:attribute>
							...
							<xsl:variable name="inputId" select="concat('enc', $encNum, $deviceType, $bayNumber, 'EbipaBayAddress')" />
							...
							<td>
								<xsl:element name="input">
									...
									<xsl:attribute name="style">width:90px;</xsl:attribute>
									<xsl:attribute name="id">
										<xsl:value-of select="concat('enc', $encNum, $deviceType, $bayNumber, 'EbipaNetmask')"/>
									</xsl:attribute>
									<xsl:attribute name="value">
										<xsl:value-of select="hpoa:bay/hpoa:netmask"/>
									</xsl:attribute>
								</xsl:element>
							</td>
							<td>
								<xsl:element name="input">
									...
									<xsl:attribute name="style">width:90px;</xsl:attribute>
									<xsl:attribute name="id">
										<xsl:value-of select="concat('enc', $encNum, $deviceType, $bayNumber, 'EbipaGateway')"/>
									</xsl:attribute>
									<xsl:attribute name="value">
							...
							<td>
								<xsl:element name="input">
									...
									<xsl:attribute name="style">width:90px;</xsl:attribute>
									<xsl:attribute name="id">
										<xsl:value-of select="concat('enc', $encNum, $deviceType, $bayNumber, 'EbipaDomain')"/>
									</xsl:attribute>
									<xsl:attribute name="value">
							...
							<td>
								<xsl:element name="input">
									...
									<xsl:attribute name="style">width:90px;</xsl:attribute>
									<xsl:attribute name="id">
										<xsl:value-of select="concat('enc', $encNum, $deviceType, $bayNumber, 'EbipaDns1')"/>
									</xsl:attribute>
									<xsl:attribute name="value">
								...
								<xsl:element name="input">
									...
									<xsl:attribute name="style">width:90px;</xsl:attribute>
									<xsl:attribute name="id">
										<xsl:value-of select="concat('enc', $encNum, $deviceType, $bayNumber, 'EbipaDns2')"/>
									</xsl:attribute>
									<xsl:attribute name="value">
								...
								<xsl:element name="input">
									...
									<xsl:attribute name="style">width:90px;</xsl:attribute>
									<xsl:attribute name="id">
										<xsl:value-of select="concat('enc', $encNum, $deviceType, $bayNumber, 'EbipaDns3')"/>
									</xsl:attribute>
									<xsl:attribute name="value">
							...
							<xsl:if test="$deviceType='interconnect'">
								<td>
									<xsl:element name="input">
										...
										<xsl:attribute name="style">width:90px;</xsl:attribute>
										<xsl:attribute name="id">
											<xsl:value-of select="concat('enc', $encNum, $deviceType, $bayNumber, 'EbipaNtp1')"/>
										</xsl:attribute>
										<xsl:attribute name="value">
											<xsl:value-of select="hpoa:bay/hpoa:ntp1"/>
										</xsl:attribute>
									</xsl:element>
									<br />
									<xsl:element name="input">
										...
										<xsl:attribute name="style">width:90px;</xsl:attribute>
										<xsl:attribute name="id">
											<xsl:value-of select="concat('enc', $encNum, $deviceType, $bayNumber, 'EbipaNtp2')"/>
										</xsl:attribute>
										<xsl:attribute name="value">
											<xsl:value-of select="hpoa:bay/hpoa:ntp2"/>
										</xsl:attribute>
									</xsl:element>
								</td>
							</xsl:if>
							<td>
								<xsl:if test="($enclosureCount!=$enclosurePosition) or position() != last()">
									...
									<xsl:element name="img">
										...
										<xsl:if test="$serviceUserAcl!='USER'">
											<xsl:attribute name="onclick">doAutoFill('<xsl:value-of select="$tableId"/>', '<xsl:value-of select="$encNum"/>', '<xsl:value-of select="$bayNumber"/>', '<xsl:value-of select="$deviceType"/>', <xsl:value-of select="$enclosureCount"/>);</xsl:attribute>
										</xsl:if>
										...
										<xsl:when test="$deviceType='server'">
											...
											<xsl:choose>
												<xsl:when test="@bladeType='BLADE_TYPE_SERVER' or @productId='8213'">
													...
													<xsl:choose>
														<xsl:when test="@currentIp != '' and @currentIp != '0.0.0.0'">
															<!-- This value comes from the blade's mp info struct. -->
															<xsl:value-of select="@currentIp"/>
														</xsl:when>
														<xsl:otherwise>
