...
<xsl:stylesheet version="1.0"
  ...
  <!--
	...
	<xsl:template match="*">
		...
		<b>
			<xsl:value-of select="$stringsDoc//value[@key='ipSettings']" /> - <xsl:value-of select="$stringsDoc//value[@key='advSettings']" />
		</b>
		<br />
		...
		<div id="stepInnerContent">
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
				<tr>
						<td>
						<xsl:value-of select="$stringsDoc//value[@key='advSettings']" /> (<xsl:value-of select="$stringsDoc//value[@key='active']" />)
						<br />
						<span class="whiteSpacer">&#160;</span>
						<br />
					...
					<xsl:if test="$hasStandby='true'">
						<td style="width:40px;">
							...
							<td>
							<xsl:value-of select="$stringsDoc//value[@key='advSettings']" /> (<xsl:value-of select="$stringsDoc//value[@key='standby']" />)
							<br />
							<span class="whiteSpacer">&#160;</span>
							<br />
							<div class="groupingBox">
			...
			<div align="right">
				<div class='buttonSet' style="margin-bottom:0px;">
					<div class='bWrapperUp'>
						<div>
							<div>
								<button type='button' onclick='setupOaNetSettingsAdvanced();'  class='hpButton' id="Button3">
