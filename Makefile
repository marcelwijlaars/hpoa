...
#	gcc -Wl,-emain -Wall -Wno-unused-variable -Wno-unused-but-set-variable -o hpoa md5/md5.c sha2/sha2.c hpoa.c
	gcc -D _GNU_SOURCE -Wall -Wno-unused-variable -Wno-unused-but-set-variable -o hpoa md5/md5.c sha2/sha2.c crc32/crc32.c hpoa.c

asan:
	gcc -fsanitize=address -g3 -D _GNU_SOURCE -Wall -Wno-unused-variable -Wno-unused-but-set-variable -o hpoa md5/md5.c sha2/sha2.c crc32/crc32.c hpoa.c
